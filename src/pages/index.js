  ...
  return (
    <Layout>
      ...
      <div className="lg:col-span-3 md:col-span-6 sm:col-span-12 col-span-12 bg-gray-800 rounded overflow-hidden shadow-lg h-48">
        <Confirmed confirmed={getConfirmed} recovered={getRecovered} deaths={getDeaths}/>
      </div>
      <div className="lg:col-span-3 md:col-span-6 sm:col-span-12 col-span-12 bg-gray-800 rounded overflow-hidden shadow-lg h-48">
        <Healing confirmed={getConfirmed} recovered={getRecovered} deaths={getDeaths}/>
      </div>
      <div className="lg:col-span-3 md:col-span-6 sm:col-span-12 col-span-12 bg-gray-800 rounded overflow-hidden shadow-lg h-48">
        <Recovered data={getRecovered} confirmed={getConfirmed} recovered={getRecovered} deaths={getDeaths}/>
      </div>
      <div className="lg:col-span-3 md:col-span-6 sm:col-span-12 col-span-12 bg-gray-800 rounded overflow-hidden shadow-lg h-48">
        <Deaths data={getDeaths} confirmed={getConfirmed} recovered={getRecovered} deaths={getDeaths}/>
      </div>
    </div>
    </Layout>
  )
